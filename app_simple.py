...
FEED_DOMAIN_MAP = {
    ...
    'jd-amazon-science':        '智能零售',
    'jd-walmart-tech':          '智能零售',
    'jd-alizila':               '智能零售',
    'jd-shopify':               '智能零售',
    'jd-shopee-blog':           '智能零售',
    'jd-meituan-tech':          '智能零售',
    'jd-arxiv-ir':              '智能零售',
    'jd-eugeneyan':             '智能零售',
    # 物流与供应链
    ...
    # 能源与可持续发展
    'jd-cleantechnica':         '能源与可持续发展',
    'jd-carbon-brief':          '能源与可持续发展',
    'jd-trellis':               '能源与可持续发展',
    'jd-canary-media':          '能源与可持续发展',
    # 医疗健康
    'jd-stat-health-tech':      '医疗健康',
    'jd-medcity-news':          '医疗健康',
    'jd-mobihealthnews':        '医疗健康',
    # 汽车与出行服务
    'jd-electrek':              '汽车与出行服务',
    'jd-electrive':             '汽车与出行服务',
    # 基础通讯
    'jd-rcr-wireless':          '基础通讯',
    # 消费电子与智能硬件
    'jd-fierce-electronics':    '消费电子与智能硬件',
    # 具身智能与机器人
    'jd-the-robot-report':      '具身智能与机器人',
    'jd-ieee-spectrum-robotics':'具身智能与机器人',
    # 跨语言与全球化
    'jd-pandaily':              '跨语言与全球化',
    'jd-scmp-tech':             '跨语言与全球化',
    'jd-technode':              '跨语言与全球化',
    'jd-restofworld':           '跨语言与全球化',
    'jd-synced':                '跨语言与全球化',
    'jd-techinasia':            '跨语言与全球化',
    # 交易服务平台
    'jd-grab-engineering':      '交易服务平台',
    # 内容直播
    # (no dedicated feeds yet — cross-covered by 智能零售 sources)
    # 社交社区
    # (no dedicated feeds yet)
    # 财报 / IR feeds → 智能零售 is the closest single domain for JD/PDD/BABA
    # but jd-earnings-analysis briefings have domain set by DeepSeek per article
    'jd-ir-jd':                 '智能零售',
    'jd-ir-pdd':                '智能零售',
    'jd-ir-alibaba':            '智能零售',
    # Cross-cutting sources (AI research, VC, infra, policy, earnings analysts, general tech media)
    # → not mapped to any single business domain; cards show no domain tag
}
...
# [row][col] = (teams, sources)  — cross-domain infra teams (AI Infra, 技术保障, 数据库与存储,
# 数据计算, 效能与中间件) power all columns; 商业智能 reads all rows. Neither is placed in cells.
MATRIX_CELLS = [
  [ # 基础通讯
    ([], ['RCR Wireless', 'Fierce Electronics']),
    ([], []),
    ([], []),
    ([], ['SRE Weekly', 'InfoQ']),
  ...
  [ # 社交社区
    ([], ['Import AI', 'UX Collective', '人人都是产品经理', 'Naavik Digest']),
    ([], ['The Gradient', 'Swyx']),
  ...
  [ # 内容直播
    ([], ['36氪AI专题', '雷锋网', 'AdExchanger', 'Digiday', 'Naavik Digest']),
    ([], ['QwenLM', 'Smashing Magazine']),
    ([], ['Nielsen Norman Group', 'UX Collective', 'Digiday']),
    ([], ['InfoQ']),
    ([], []),
  ],
  [ # 智能零售
    ([], ['Modern Retail', 'Retail Dive', 'Digital Commerce 360', '亿邦动力', 'AdExchanger', 'Axios AI']),
    ([], ['Amazon Science', 'Eugene Yan', 'arXiv cs.IR', 'Walmart Global Tech', 'Logistics Viewpoints']),
    ([], ['Shopify Blog', 'Practical Ecommerce', 'Shopee Blog', 'Nielsen Norman Group']),
    ([], ['Instacart Tech', 'SRE Weekly', 'InfoQ']),
    ([], ['arXiv cs.LG', 'Chip Huyen', 'Hugging Face Blog']),
  ],
  [ # 交易服务平台
    ([], ['36氪', '虎嗅', '品玩PingWest', 'KrAsia']),
    ([], ['Stripe Blog', 'Sift Blog']),
    ([], ['Nielsen Norman Group', 'Smashing Magazine']),
    ([], ['Grab Engineering', 'SRE Weekly']),
    ([], ['Sift Blog']),
  ],
  [ # 广告营销
    ([], ['AdExchanger', 'Digiday', 'Crunchbase News']),
    ([], ['AdExchanger', 'Digiday']),
  ...
  [ # 金融与支付
    ([], ['Finextra', 'PYMNTS', 'Payments Dive', 'Digital Transactions']),
    ([], ['Stripe Blog', 'Atlantic Council CBDC', 'Coin Center']),
    ([], ['PYMNTS', 'Nielsen Norman Group', 'Payments Dive']),
    ([], ['Finextra', 'Sift Blog', 'SRE Weekly']),
    ([], ['Sift Blog', 'Stripe Blog', 'Atlantic Council CBDC']),
  ],
  [ # 物流与供应链
    ([], ['Supply Chain Dive', 'DC Velocity', 'FreightWaves', 'The Loadstar', 'SupplyChainBrain']),
    ([], ['Supply Chain Dive', 'Logistics Viewpoints', 'DC Velocity', 'FreightWaves', 'SupplyChainBrain']),
    ([], ['UX Collective']),
    ([], ['SRE Weekly', 'InfoQ']),
    ([], ['Logistics Viewpoints', 'IEEE Spectrum Robotics']),
  ],
  [ # 具身智能与机器人
    ([], ['The Robot Report']),
    ([], ['fast.ai', 'Nathan Lambert', 'Lilian Weng', 'The Robot Report', 'Logistics Viewpoints']),
    ([], ['Smashing Magazine']),
    ([], ['SRE Weekly', 'InfoQ']),
    ([], ['Chip Huyen', 'arXiv cs.LG', 'IEEE Spectrum Robotics', 'The Robot Report']),
  ],
  [ # 能源与可持续发展
    ([], ['CleanTechnica', 'Trellis', 'Canary Media']),
    ([], ['Trellis', 'Carbon Brief', 'Canary Media']),
    ([], ['UX Collective']),
    ([], ['Carbon Brief', 'SRE Weekly']),
    ([], ['CleanTechnica', 'IEEE Spectrum Robotics']),
  ],
  [ # 医疗健康
    ([], ['MedCity News', 'STAT Health Tech', 'MobiHealthNews']),
    ([], ['STAT Health Tech', 'MedCity News', 'MobiHealthNews']),
    ([], ['Nielsen Norman Group', 'STAT Health Tech']),
    ([], ['SRE Weekly', 'InfoQ']),
    ([], ['STAT Health Tech', 'arXiv cs.LG']),
  ],
  [ # 消费电子与智能硬件
    ([], ['36氪融资快讯', 'Crunchbase News', 'Fierce Electronics', 'Ars Technica']),
    ([], ['Andrej Karpathy', 'Smashing Magazine', 'Hugging Face Blog']),
    ([], ['Nielsen Norman Group', 'Smashing Magazine']),
    ([], ['SRE Weekly', 'InfoQ']),
    ([], ['IEEE Spectrum Robotics', 'Chip Huyen']),
  ],
  [ # 跨语言与全球化
    ([], ['KrAsia', 'Tech in Asia', 'Synced', 'MIT科技评论中文版', 'Supply Chain Dive']),
    ([], ['QwenLM', 'Logistics Viewpoints']),
    ([], ['Nielsen Norman Group', 'UX Collective']),
    ([], ['亿邦动力', 'InfoQ']),
    ([], ['QwenLM', 'arXiv cs.LG']),
  ],
  [ # 汽车与出行服务
    ([], ['Electrek', 'CleanTechnica', 'Electrive']),
    ([], ['Andrej Karpathy', 'Electrek', 'Electrive']),
    ([], ['Nielsen Norman Group', 'UX Collective']),
    ([], ['Grab Engineering', 'SRE Weekly']),
    ([], ['IEEE Spectrum Robotics', 'arXiv cs.LG']),
  ],
]
