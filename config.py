...

{
    ...
    # ========== 五、英文科技媒体·深度报道补充 (用于多源故事合成) ==========
    {
        "name": "Wired",
        "url": "https://www.wired.com/feed/rss",
        "priority": "high",
        "criteria": """
        【重点关注】AI/算力/科技产业的社会影响、商业逻辑与权力格局变化。
        重点：科技巨头的战略博弈、AI对劳动力/创作/社会的深层重塑、科技政策走向。
        可接受：有深度叙事的公司报道、技术文化评论。
        严格排除：消费品评测、生活方式内容、纯新闻快讯。"""
    },
    {
        "name": "Ars Technica",
        ...
        "priority": "high",
        "criteria": """
        【重点关注】AI/芯片/云计算/企业软件的技术深度分析。
        重点：大模型技术架构解析、芯片设计与制造竞争、开源生态动向、安全漏洞与系统可靠性。
        可接受：有技术细节的产品评测、科学研究的工程应用。
        严格排除：游戏新闻、娱乐、纯消费电子开箱。"""
    },
    {
        ...
        "priority": "high",
        "criteria": """
        【重点关注】将前沿AI/量子/生物科技研究转化为产业洞见的深度报道。
        重点：大模型能力边界与局限、AI安全与对齐进展、颠覆性技术的商业化路径。
        可接受：有实证支撑的技术趋势预测、研究机构与产业的交叉报道。
        严格排除：纯学术摘要、与技术商业化无关的基础科学。"""
    },
    {
        "name": "VentureBeat",
        ...
        "priority": "high",
        "criteria": """
        【重点关注】企业AI落地、生成式AI商业化、AI基础设施投资与竞争格局。
        重点：AI Agent/RAG/LLMOps的企业实践、大模型API竞争、AI芯片与云平台格局。
        可接受：AI创业公司的产品发布与融资（需有战略意义）、CTO/CIO视角的技术决策。
        严格排除：无商业意义的学术新闻、游戏/娱乐、纯融资快讯。"""
    },
    {
        "name": "机器之心",
        ...
        "priority": "high",
        "criteria": """
        【重点关注】中国AI研究进展、国产大模型动态、AI工程化落地实践。
        重点：国产大模型（DeepSeek/Qwen/文心等）技术解读、顶会论文产业影响分析、AI芯片国产化进展。
